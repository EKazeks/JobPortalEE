...
const CompanyNavBarComponent = ({
  ...
  const displayAllNavItems = companyName !== undefined ? true : true; //  1. When users are newly registered, hide secondary nav.
            ...
            <Toolbar>
              <Typography variant="h6" className={classes.secondaryMenu}>
                <Link
                  ...
                  className={
                    selectedMainMenu === 1 &&
                    location.pathname === "/omat-ilmoitukseni"
                      ? classes.activeNav
                      : classes.inactiveNav
                  }
                >
